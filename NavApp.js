...
export function registerScreens() {
    ...
    Navigation.registerComponent('pages.Problem', () =>
        gestureHandlerRootHOC(Problem));
    Navigation.registerComponent('screens.VilleInRegion', () =>
        gestureHandlerRootHOC(VilleInRegion));
    Navigation.registerComponent('components.Camera', () =>
...
const TakePhoto = createStackNavigator({

        Photo: {
            screen: Camera,
            navigationOptions: ({navigation}) => ({
                header: <BackHeader title="Prendre une photo" navigationProps={navigation}/>,
